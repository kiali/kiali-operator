...
# Completed!
echo "New Kiali metadata has been added to new branches in the community git repo."
...
echo "2. cd ${GIT_REPO_OPERATORHUB} && git push <your git remote name> ${GIT_REPO_UPSTREAM_BRANCH_NAME}"

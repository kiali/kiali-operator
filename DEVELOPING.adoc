...
When making any kind of change, you should also make the necessary changes to the link:./molecule/[molecule tests] to ensure they still pass. You can easily run the molecule tests on your local box via Minikube by running the link:https://github.com/kiali/kiali/blob/master/hack/ci-minikube-molecule-tests.sh[ci-minikube-molecule-tests.sh] hack script.

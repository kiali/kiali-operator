...
- [ ] Document the new value in the link:./crd-docs/config/crd/kiali.io_kialis.yaml[CRD schema] (and put the default values in the link:./crd-docs/docs/cr/kiali.io_v1alpha1_kiali.yaml[example CR])

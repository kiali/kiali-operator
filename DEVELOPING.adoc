...
- [ ] Modify the link:https://github.com/kiali/kiali-operator/tree/master/roles/default/kiali-deploy/templates/dashboards[templates used by the Operator]
- [ ] Modify the link:https://github.com/kiali/helm-charts/tree/master/kiali-server/templates/dashboards[templates used by the Server Helm Chart]
